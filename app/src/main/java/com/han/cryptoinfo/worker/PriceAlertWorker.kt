package com.han.cryptoinfo.worker
...
import com.han.cryptoinfo.api.TickerHourApi
import com.han.cryptoinfo.api.TickerHourResponse
...
class PriceAlertWorker(val context: Context, workerParam: WorkerParameters) :
    ...
    override fun doWork(): Result {
        ...
        val priceAlertDao = CryptoInfoDatabase.getDB(context).priceAlertDao()
